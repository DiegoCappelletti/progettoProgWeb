 ...
 * @author Alessio
 */
public class MedicoSSchedaPazienteFilter implements Filter {
    ...
    public MedicoSSchedaPazienteFilter() {
    }    
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        try {
            ...
            List<Visita> visiteNonEseguite = medicoDao.getNEVisiteByPazienteSpecID(paziente, medico.getSpecializzazione().getSpecId());
