...
<c:catch var="ex">
    ...
    <body>
        ...
        <nav id="sidebar" class="text-center">
            ...
            <ul class="list-unstyled">        
                ...
                <li>
                    <a class="nav-link" href="<c:url context="${contextPath}" value="/services/Report.handler"/>">
                        <i class="fas fa-list"></i>
                        Crea report
                    </a>
                </li>
	...
	<!-- Page Content  -->
        <div id="content">
            ...
            <div class="patient-exams-content p-3">
                    ...
                    <tbody>
                        <c:forEach var="paziente" items="${pazienti}">
                            <tr>
                                ...
                                <td>
                                    <a class="nav-link" href="<c:url value='/riservato/ssp/scheda-paziente.html?id=${paziente.utenteId}'/>">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <textarea id="risultati" name="risultati" cols="60" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Annulla</button>
                        <button id="esegui-visita" type="button" class="btn btn-primary">Conferma</button>
                    </div>
                </div>
            </div>
	</div>
